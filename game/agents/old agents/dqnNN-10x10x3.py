...
#
#         self.num_games = -1
#         self.n_inputs = (BOARD_DIM, BOARD_DIM, 3) #3 * BOARD_SIZE
...
#         states = np.zeros((batch_size, 10,10,3))
#         next_states = np.zeros((batch_size,10,10,3))
...
#
#         assert states.shape == (batch_size, 10,10,3)
#         assert next_states.shape == (batch_size, 10,10,3)
#
