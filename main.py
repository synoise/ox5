...
# def initiateAgents():
    ...
    #                                      seed=seed1)
    #
    # dqn_second2 = DQNAtempEnd(i_agent=0,
    #                                   is_learning=False,
    #                                   learning_rate=0.001,
    #                                   gamma=0.95,
    #                                   epsilon=0.6,
...
for I in range(150):
    ...
    results = play_games(lambda: TicTacToeGame(), [ human, dqn_second], 1500, paths = [first1, second2], plot=False, debug=True)
